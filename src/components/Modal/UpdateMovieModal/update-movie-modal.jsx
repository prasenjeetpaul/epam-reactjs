...
const UpdateMovieModal = ({ movieItem, updateMovie }) => {
    ...
    const initialValues = { title, releaseDate: release_date, posterURL: poster_path, genre: genres[0], overview, runtime };
    ...
    const onSubmit = () => {
        if (formik.isValid) {
            ...
            updateMovie({ id: movieItem.id, title, release_date: releaseDate, poster_path: posterURL, genres: [genre], overview, runtime })
        } else {

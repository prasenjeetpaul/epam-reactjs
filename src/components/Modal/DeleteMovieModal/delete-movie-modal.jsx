...
const DeleteMovieModal = ({ movieID, deleteMovie }) => (
    <div className="modal-content">
        <div className="modal-action">
            <div className="modal-close-icon clickable">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 311 311.07733" onClick={() => ModalService.closeModal()}>
...
const deleteMovie = dispatch => movieID => axios.delete(`${URLS.MOVIE_LIST}/${movieID}`)
    .then(data => data.data)
    .then(() => {
...
const component = connect(null, mapDispatchToProps)(DeleteMovieModal);

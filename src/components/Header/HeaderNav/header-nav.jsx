...
const HeaderNav = ({ selectedMovieItem, updateSelecteMovie }) => (
    <nav>
        ...
        <div className="nav-action">
            ...
            {selectedMovieItem && (
                <span className="search-icon" onClick={() => updateSelecteMovie(null)}>
...
const component = connect(mapStateToProps, mapDispatchToProps)(HeaderNav);

export { component as HeaderNav };
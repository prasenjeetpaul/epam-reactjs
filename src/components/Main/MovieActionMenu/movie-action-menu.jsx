        ...
        <React.Fragment>
            ...
            <div className={isMenuVisible ? 'movie-item-action' : 'movie-item-action hidden'}>
                <div className="close-button clickable">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 311 311.07733" onClick={() => setMenuVisible(false)}>
                ...
                <ul>
                    <li onClick={() => ModalService.openUpdateMovieModal()}>Edit</li>
                    <li onClick={() => ModalService.openDeleteMovieModal()}>Delete</li>
                </ul>
            </div>
        </React.Fragment>
    )
